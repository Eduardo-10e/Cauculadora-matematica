...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ---- EVENT LISTENERS PARA OS BOTÕES (Calculadoras) ----
    ...
    // ---- FUNÇÕES AUXILIARES (Validação e Helpers) ----

    /**
     * Função principal de leitura. Retorna NaN se estiver vazio ou inválido.
     */
    ...
    /**
     * Função de leitura para Pitágoras. 
     * Retorna 'null' se vazio, NaN se inválido, ou o número.
     */
    function lerValorPitagoras(id) {
        const elemento = document.getElementById(id);
        if (!elemento) { return NaN; } // Erro de dev

        var valorStr = elemento.value.trim();
        
        if (valorStr === "") {
            elemento.style.borderColor = ''; // Limpa a borda (vazio é permitido)
            return null; 
        }
    ...
    // ---- LÓGICA DE NAVEGAÇÃO PRINCIPAL (Calculadora vs Aprendizado) ----
    ...
    // ---- LÓGICA DE NAVEGAÇÃO SECUNDÁRIA (Álgebra vs Geometria) ----
    ...
    // ---- LÓGICA DE NAVEGAÇÃO TERCIÁRIA (Sub-nav da Álgebra) ----
